...
dashboardRoutes.get("/developer", (req: Request, res: Response) => {
  res.sendFile(
    path.join(__dirname, "../developer/html/developer_dashboard.html"),
  );
});
dashboardRoutes.get("/employer", (req: Request, res: Response) => {
  res.sendFile(
    path.join(__dirname, "../employer/html/employer_dashboard.html"),
  );
});
...
dashboardRoutes.get(
  ...
  employerDbController.getUserDetails,
);
...
dashboardRoutes.post(
  "/employer/accepted_job",
  employerDbController.accepted_job,
);
dashboardRoutes.post(
  "/employer/rejected_job",
  employerDbController.rejected_job,
);
...
dashboardRoutes.get(
  ...
  developerDbController.application,
);
