...
export default class GithubService {
    ...
    async employee_user_data(github_username: any, github_id: any, github_token: any): Promise<github_Users | null> {     
        try {
    ...
    async employer_user_data(github_username: any, github_id: any, github_token: any): Promise<github_Users | null> {
        try {
            const existingUser = await this.knex("users")
                .select("id")
                .where("github_id", github_id)
