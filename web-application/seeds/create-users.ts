...
export async function seed(knex: Knex): Promise<void> {
  ...
  try {
    ...
    const developer_data = await trx("developer_data")
      .insert([
        {
          user_id: bbb.id,
          education_level: "aaa",
    ...
    await trx("skill_recommendations")
      .insert([
        {
      ...
      .insert([
        {
          ...
          location: "Sheung Wan",
          about:
            "Founded in 2021, CodePredictPay is a company that provides a platform for developers to find jobs and for employers to find developers.",
        },
      ])
      .returning("id");
