    ...
    constructor(private jobPostingService: JobPostingService) {
        ...
        jobPosting = async (req: Request, res: Response) => {
            ...
            try {
                ...
                const result = await jobPostingService.jobPosting(company_id, job_title, work_place, employment_type, job_description, experience_level, responsibilities, qualifications, skills);
